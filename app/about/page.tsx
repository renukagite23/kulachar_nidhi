      ...
      <main className="flex-grow">
        ...
        <section className="relative py-20 bg-secondary text-white overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 relative z-10 text-center">
            ...
            <p className="text-accent font-bold uppercase tracking-[0.3em] text-sm">{t('about.subtitle')}</p>
          </div>
        </section>
          ...
          <div className="grid md:grid-cols-12 gap-12 items-start">
            ...
            <div className="md:col-span-8 space-y-8">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-black text-primary mb-4 flex items-center gap-2">
                    <Award className="w-5 h-5" /> {t('about.major_works')}-
                  </h3>
                ...
                <div>
                  <h3 className="text-xl font-black text-primary mb-4 flex items-center gap-2">
                    <Building2 className="w-5 h-5" /> {t('about.staff_quarters')}-
                  </h3>
                  <p className="text-secondary/70 leading-relaxed">
                    {t('about.staff_desc')}
                  </p>
              ...
              <div className="bg-muted p-8 rounded-3xl border border-border italic text-secondary/60 text-sm">
                "{t('about.donor_remembrance')}"
              </div>

              <div className="text-right pt-8">
                <p className="text-xl font-black text-secondary">{t('about.president_name')}</p>
                <p className="text-sm font-bold text-primary italic">{t('about.president_role')}</p>
            ...
            <div className="md:col-span-4 sticky top-24">
              ...
              >
                ...
                <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 bg-white px-8 py-4 rounded-2xl shadow-xl border border-border w-[90%] text-center">
                  ...
                  <p className="text-xs font-bold text-secondary italic">{t('about.badges.mandate')}</p>
                </div>
              </motion.div>
            </div>
        ...
        <section className="bg-muted py-16">
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {[
                { label: t('about.stats.devotees'), value: t('about.stats.devotees_val'), icon: Users2 },
                { label: t('about.stats.established'), value: t('about.stats.established_val'), icon: Building2 },
                { label: t('about.stats.staff'), value: t('about.stats.staff_val'), icon: Users2 },
                { label: t('about.stats.prasadalaya'), value: t('about.stats.free'), icon: Award },
              ].map((item, idx) => (
