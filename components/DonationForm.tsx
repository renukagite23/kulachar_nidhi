...
export default function DonationForm() {
  ...
  const reasons = ['वाढदिवस', 'नवरात्र', 'जवाळ (मुंजी)', 'इतर'];
      ...
      <div className="bg-white rounded-[2.5rem] p-6 md:p-10 border border-border shadow-2xl relative overflow-hidden">
        ...
        <AnimatePresence mode="wait">
          {step === 1 && (
            ...
            >
              <div className="space-y-1">
                <h2 className="text-xl font-black text-secondary">योगदान निवडा</h2>
                <p className="text-muted-foreground text-xs font-medium">आपले योगदान धर्मादाय कार्यासाठी वापरले जाईल.</p>
              </div>
              ...
              <div className="space-y-3">
                <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">देणगीचे कारण</label>
                <div className="flex flex-wrap gap-2">
                  {reasons.map((r) => (
                    <button
                      key={r}
                      onClick={() => setFormData({ ...formData, reason: r })}
                      className={`px-4 py-2 rounded-xl border text-[11px] font-bold transition-all ${formData.reason === r
          ...
          {step === 2 && (
            ...
            >
              <div className="space-y-1">
                <h2 className="text-xl font-black text-secondary">भक्ताची माहिती</h2>
                <p className="text-muted-foreground text-xs font-medium">पावतीसाठी आपले नाव व संपर्क क्रमांक द्या.</p>
              </div>
          ...
          {step === 3 && (
            ...
            >
              ...
              <div className="bg-muted/50 rounded-3xl p-6 flex justify-between items-center border border-border">
                <div>
                  <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest mb-1">एकूण रक्कम</p>
                  <p className="text-4xl font-black text-primary">₹{formData.amount || formData.customAmount}</p>
                </div>
                <div className="text-right">
                  <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest mb-1">भक्त</p>
          ...
          {step === 4 && lastDonation && (
            ...
            >
              <div className="space-y-3">
                ...
                <div>
                  <h2 className="text-2xl font-black text-secondary">धन्यवाद!</h2>
                  <p className="text-muted-foreground text-sm font-medium">आपली भक्तीपूर्ण देणगी आम्हाला प्राप्त झाली आहे.</p>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-10 pt-10">
                <button onClick={handleDownload} className="spiritual-button px-8 h-12 text-xs gap-2">
                  <Download className="w-4 h-4" /> पावती डाऊनलोड करा
                </button>
